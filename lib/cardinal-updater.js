...
function copyBuild() {
    ...
    try {
        ...
        // RecursionCopy(['../' + CARDINAL_PATH + '/release/cardinal.js', '../' + CARDINAL_PATH + '/release/cardinal', '../' + CARDINAL_PATH + '/release/themes/default'], ['./', './cardinal/', './themes/'])
    } catch (err) {
        console.log("The files couldn't be copied, error:", err)
    }
}
// function RecursionCopy(folderPath, destinationPath) {
