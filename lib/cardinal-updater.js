...
function deleteFiles(cb) {
    ...
    // if (RecursionDeletion('./cardinal')) {
    //     console.log('Good job on deleting the cardinal files')
    // }
    // if (RecursionDeletion('./themes/default')) {
    //     console.log('Good job on deleting the default theme files')
    // };
    // if (RecursionDeletion('../cardinal/release/cardinal')) {
    //     console.log('Good job on deleting the release cardinal files')
    // }
    fs.rmdir('./cardinal',function(err){
        if(err){
            console.log('EROARE AICI',err)
        }
    })
    fs.rmdir('./themes/default',function(err){
        if(err){
            console.log('EROARE AICI',err)
        }
    })
    fs.rmdir('../cardinal/release/cardinal',function(err){
        if(err){
            console.log('EROARE AICI',err)
        }
    })
...
async function RecursionDeletion(folderPath) {
    ...
    //             } else {
    //                 await fs.unlinkSync(folderPath + path);
    //             }
    //         }
    //     }
    // })
